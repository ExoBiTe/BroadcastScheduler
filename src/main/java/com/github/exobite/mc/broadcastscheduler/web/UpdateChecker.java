package com.github.exobite.mc.broadcastscheduler.web;

import com.github.exobite.mc.broadcastscheduler.PluginMaster;
import com.github.exobite.mc.broadcastscheduler.utils.VersionHelper;
...
public class UpdateChecker {
    ...
    private void start(boolean useBukkitAsyncScheduler) {
        ...
        if(RESOURCE_ID <= 0) {
            PluginMaster.sendConsoleMessage(Level.WARNING, "Unknown Plugin ID, no UpdateCheck is happening!");
            return;
        }
